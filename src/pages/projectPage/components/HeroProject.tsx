...
const HeroProject: FunctionComponent<HeroProjectProps> = ({ imageBG, image, resImage }) => {
	...
	return (
		<div className="w-full md:h-[52.5rem] sm:h-[42.5rem] relative z-30 bg-projectBlack ">
			<div className="container mx-auto">
				...
				<LazyLoadImage src={image.url} alt={image.alt} className="h-[44.4rem] 	 md:px-[7rem] sm:px-[1.8rem]  mx-auto    pt-[4.2rem] relative bottom-[28.5rem] md:left-[45rem] sm:left-[0rem]" effect="opacity" />
			</div>
		</div>
	);
};
