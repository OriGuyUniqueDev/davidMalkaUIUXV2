		...
		>
			<>
				...
				<span className="mb-[3.9rem] mt-[4.4rem] block w-[20.5rem]">
					<ButtonTextWithIcon
						borderColor="border-projectWhite"
						text={"Prototype"}
						image={{ url: "/icons/leftArrowWhite.svg", alt: "arrow icon" }}
					/>
				</span>
				<SubTitle subTitleText={subTitleText} />
				<div className="relative flex flex-col items-center pb-[24rem]">
					<img
						className="mt-[4.4rem] w-[100vw]"
						src={image[0].url}
						alt={image[0].alt}
					/>
