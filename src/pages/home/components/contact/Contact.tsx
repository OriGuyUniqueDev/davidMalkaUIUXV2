...
const Contact: FunctionComponent<ContactProps> = () => {
	return (
		<div className="w-full  flex flex-col md:py-[12rem] sm:py-[8.6rem] bg-projectBlack items-center justify-center md:gap-[5.9rem] sm:gap-[4.5rem]">
			...
			<a className="flex gap-5 w-[22rem] md:mt-[4.5rem] h-[6.1rem]  border-2 items-center justify-center border-projectWhite text-3xl text-projectWhite " href="mailto:dudu5malka@gmail.com">
