	...
	return (
		<div className="w-full h-[81.2rem]   bg-projectBlack x-28">
			<div className="container mx-auto">
				<LazyLoadImage src="images/homePage/hero.webp" alt="hero img" width="100%" className=" w-[112.3rem] mx-auto h-[65.2rem] pt-[4.2rem] relative" placeholderSrc={"loading..."} effect="opacity" />
